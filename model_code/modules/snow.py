...
#caw EDIT, 2025-10-15, REmoce sNOWr_glac FROM snow processes
def dynamic(self, pcr, Temp, Precip, Snow_GLAC, ActSnowMelt_GLAC, SnowFrac, RainFrac, SnowR_GLAC):
    ...
    # CAW edit, 2025-10-15, remove glacier snow fraction
    SnowR = self.snow.SnowR(pcr, self.SnowWatStore, MaxSnowWatStore, ActSnowMelt, Rain, OldSnowWatStore, SnowFrac) # for entire cell

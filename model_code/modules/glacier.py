...
def dynamic(self, pcr, pd, Temp, Precip):
    ...
    # CAW EDIT, 2025-10-15
    # Add snowmelt runoff on glaciers to glacier melt
    self.GlacTable['GlacMelt'] = self.GlacTable['GlacMelt'] + self.GlacTable['SnowR_GLAC']
    # CAW, end of edit, 2025-10-15
    #-Glacier runoff
